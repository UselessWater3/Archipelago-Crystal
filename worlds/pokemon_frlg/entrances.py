...
SINGLE_BUILDING_ENTRANCES = [
    ...
    "Route 2 Trade House Entrance", "Pewter Museum Entrance (West)", "Pewter Museum Entrance (East)",
    "Pewter Nidoran House Entrance", "Pewter Info House Entrance", "Cerulean Trade House Entrance",
    "Bike Shop Entrance", "Wonder News House Entrance", "Berry Powder Man's House Entrance", "Sea Cottage Entrance",
    "Route 5 Pokemon Day Care Entrance", "Vermilion Fishing House Entrance", "Pokemon Fan Club Entrance",
    "Vermilion Trade House Entrance", "Vermilion Pidgey House Entrance", "Volunteer Pokemon House Entrance",
    "Lavender Cubone House Entrance", "Name Rater's House Entrance", "Celadon Game Corner Entrance",
    "Celadon Condominiums Entrance (Front)", "Celadon Condominiums Entrance (Back)",
    "Celadon Game Corner Prize Room Entrance", "Celadon Restaurant Entrance", "Celadon Rocket House Entrance",
    "Celadon Hotel Entrance", "Route 12 Fishing House Entrance", "Route 16 Fly House Entrance",
    "Safari Zone Warden's House Entrance", "Safari Zone Office Entrance", "Bill's Grandpa's House Entrance",
    "Move Deleter's House Entrance", "Copycat's House Entrance", "Saffron Dojo Entrance",
    "Saffron Pidgey House Entrance", "Mr. Psychic's House Entrance", "Pokemon Trainer Fan Club Entrance",
    "Pokemon Lab Entrance", "One Island Old Couple's House Entrance", "One Island Lass' House Entrance",
    "Ember Spa Entrance", "Two Island Game Corner Entrance", "Move Maniac's House Entrance",
    "Starter Tutor's House Entrance", "Lostelle's House Entrance", "Sabrina Fan's House Entrance",
    "Three Island Beauty's House Entrance", "Three Island Worried Father's House Entrance",
    "Lostelle's Friend's House Entrance", "Four Island Pokemon Day Care Entrance", "Move Tutor's House Entrance",
    "Lorelei's House Entrance", "Sticker Man's House Entrance", "Five Island Couple's House Entrance",
    "Five Island Old Man's House Entrance", "Selphy's House Entrance", "Six Island Old Man's House Entrance",
    "Water Path Heracross Woman's House Entrance", "Water Path Man's House Entrance",
    "Seven Island Trainer Battle House Entrance", "Tanoby Key Entrance", "Sevault Canyon Chansey House Entrance",
...
SINGLE_BUILDING_EXITS = [
    ...
    "Route 2 Trade House Exit", "Pewter Museum 1F Exit (West)", "Pewter Museum 1F Exit (East)",
    ...
    "Name Rater's House Exit", "Celadon Game Corner Exit", "Celadon Condominiums 1F Exit (Front)",
    "Celadon Condominiums 1F Exit (Back)", "Celadon Game Corner Prize Room Exit", "Celadon Restaurant Exit",
...
MULTI_BUILDING_ENTRANCES = [
    "Route 22 Gate Entrance (South)", "Route 22 Gate Entrance (North)", "Viridian Forest South Gate Entrance",
    "Viridian Forest North Gate Entrance", "Route 2 Gate Entrance (North)", "Route 2 Gate Entrance (South)",
    "Badge Guy's House Entrance (Front)", "Badge Guy's House Entrance (Back)", "Robbed House Entrance (Front)",
    "Robbed House Entrance (Back)", "Route 5 Gate Entrance (North)", "Route 5 Gate Entrance (South)",
    "Underground Path Entrance (North)", "Underground Path Entrance (South)", "Route 6 Gate Entrance (South)",
    "Route 6 Gate Entrance (North)", "Route 11 Gate Entrance (West)", "Route 11 Gate Entrance (East)",
    "Route 8 Gate Entrance (East)", "Route 8 Gate Entrance (West)", "Underground Path Entrance (East)",
    "Underground Path Entrance (West)", "Route 7 Gate Entrance (West)", "Route 7 Gate Entrance (East)",
    "Celadon Department Store Entrance (West)", "Celadon Department Store Entrance (East)",
    "Route 12 Gate Entrance (North)", "Route 12 Gate Entrance (South)", "Route 15 Gate Entrance (East)",
    "Route 15 Gate Entrance (West)", "Route 16 Gate Entrance (East - Top)", "Route 16 Gate Entrance (West - Top)",
    "Route 16 Gate Entrance (East - Bottom)", "Route 16 Gate Entrance (West - Bottom)", "Route 18 Gate Entrance (West)",
    "Route 18 Gate Entrance (East)", "Fuchsia Fishing House Entrance (Front)", "Fuchsia Fishing House Entrance (Back)",
    "Three Isle Path Entrance (West)", "Three Isle Path Entrance (East)"
]

MULTI_BUILDING_EXITS = [
    "Route 22 Gate Exit (South)", "Route 22 Gate Exit (North)", "Viridian Forest South Gate Exit (South)",
    "Viridian Forest North Gate Exit (North)", "Route 2 Gate Exit (North)", "Route 2 Gate Exit (South)",
    "Badge Guy's House Exit (Front)", "Badge Guy's House Exit (Back)", "Robbed House Exit (Front)",
    "Robbed House Exit (Back)", "Route 5 Gate Exit (North)", "Route 5 Gate Exit (South)",
    "Underground Path 1F Exit (North)", "Underground Path 1F Exit (South)", "Route 6 Gate Exit (South)",
    "Route 6 Gate Exit (North)", "Route 11 Gate 1F Exit (West)", "Route 11 Gate 1F Exit (East)",
    "Route 8 Gate Exit (East)", "Route 8 Gate Exit (West)", "Underground Path 1F Exit (East)",
    "Underground Path 1F Exit (West)", "Route 7 Gate Exit (West)", "Route 7 Gate Exit (East)",
    "Celadon Department Store 1F Exit (West)", "Celadon Department Store 1F Exit (East)",
    "Route 12 Gate 1F Exit (North)", "Route 12 Gate 1F Exit (South)", "Route 15 Gate 1F Exit (East)",
    "Route 15 Gate 1F Exit (West)", "Route 16 Gate 1F Exit (East - Top)", "Route 16 Gate 1F Exit (West - Top)",
    "Route 16 Gate 1F Exit (East - Bottom)", "Route 16 Gate 1F Exit (West - Bottom)", "Route 18 Gate 1F Exit (West)",
    "Route 18 Gate 1F Exit (East)", "Fuchsia Fishing House Exit (Front)", "Fuchsia Fishing House Exit (Back)",
...
SINGLE_DUNGEON_EXITS = [
    ...
    "Safari Zone Lobby Exit", "Silph Co. 1F Exit", "Pokemon Mansion 1F Exit (West)", "Cerulean Cave 1F Exit",
    "Navel Rock 1F Exit", "Mt. Ember Exterior Exit", "Berry Forest Exit", "Icefall Cave Front Exit (South)",
...
MULTI_DUNGEON_ENTRANCES = [
    "Viridian Forest South Gate Exit (North)", "Viridian Forest North Gate Exit (South)", "Mt. Moon Entrance (West)",
    "Mt. Moon Entrance (East)", "Diglett's Cave Entrance (North)", "Diglett's Cave Entrance (South)",
    "Rock Tunnel Entrance (North)", "Rock Tunnel Entrance (South)", "Power Plant Entrance (Front)",
    "Power Plant Entrance (Back)", "Seafoam Islands Entrance (North)", "Seafoam Islands Entrance (South)",
    "Victory Road Entrance (West)", "Victory Road Entrance (East)", "Pattern Bush Entrance (West)",
    "Pattern Bush Entrance (East)"
]

MULTI_DUNGEON_EXITS = [
    "Viridian Forest Exit (South)", "Viridian Forest Exit (North)", "Mt. Moon 1F Exit",
    "Mt. Moon B1F East Ladder (Fourth Tunnel)", "Diglett's Cave 1F Exit (North)", "Diglett's Cave 1F Exit (South)",
    "Rock Tunnel 1F North Ladder", "Rock Tunnel 1F Exit", "Power Plant Exit (Front)", "Power Plant Exit (Back)",
    "Seafoam Islands 1F Exit (West)", "Seafoam Islands 1F Exit (East)", "Victory Road 1F Exit", "Victory Road 2F Exit",
...
INTERIOR_WARPS = [
    ...
    "Mt. Moon B2F Center Ladder", "Mt. Moon B2F Northwest Ladder", "Underground Path 1F Stairs (North)",
    "Underground Path B1F North Stairs", "Underground Path B1F South Stairs", "Underground Path 1F Stairs (South)",
    ...
    "Diglett's Cave 1F Ladder (South)", "Diglett's Cave B1F Northwest Ladder", "Diglett's Cave B1F Southeast Ladder",
    "Diglett's Cave 1F Ladder (North)", "Route 11 Gate 1F Stairs", "Route 11 Gate 2F Stairs",
    ...
    "Rock Tunnel B1F Center Ladder", "Rock Tunnel B1F Northwest Ladder", "Underground Path 1F Stairs (East)",
    "Underground Path B1F East Stairs", "Underground Path B1F West Stairs", "Underground Path 1F Stairs (West)",
    ...
    "Safari Zone Center Area Exit (West)", "Safari Zone East Area Exit (West - Top)",
    "Safari Zone East Area Exit (West - Bottom)", "Safari Zone East Area Rest House Entrance",
    "Safari Zone North Area Exit (South - Left)", "Safari Zone North Area Exit (South - Center)",
    "Safari Zone North Area Exit (East)", "Safari Zone North Area Exit (South - Right)",
    "Safari Zone North Area Rest House Entrance", "Safari Zone West Area Exit (North - Right)",
    "Safari Zone West Area Exit (East)", "Safari Zone West Area Rest House Entrance",
    "Safari Zone West Area Exit (North - Left)", "Safari Zone Secret House Entrance",
    ...
    "Silph Co. 5F Northeast Stairs (Left)", "Silph Co. 5F Northeast Stairs (Right)", "Silph Co. 6F North Stairs",
    "Silph Co. 6F Northeast Stairs", "Silph Co. 7F North Stairs", "Silph Co. 7F Northeast Stairs",
    "Silph Co. 8F North Stairs", "Silph Co. 8F Northeast Stairs", "Silph Co. 9F North Stairs (Left)",
    ...
    "Mt. Ember Ruby Path Entrance", "Mt. Ember Summit Path Entrance (Bottom)", "Mt. Ember Summit Path Entrance (Top)",
    "Mt. Ember Summit Entrance", "Mt. Ember Summit Path 1F Exit (South)", "Mt. Ember Summit Path 1F Exit (North)",
    "Mt. Ember Summit Path 2F Exit (South)", "Mt. Ember Summit Path 2F Exit (North)",
    "Mt. Ember Summit Path 3F Exit (West)", "Mt. Ember Summit Path 3F Exit (East)", "Mt. Ember Summit Exit",
    "Mt. Ember Ruby Path 1F Exit", "Mt. Ember Ruby Path 1F Northwest Ladder", "Mt. Ember Ruby Path 1F Northeast Ladder",
    ...
    "Mt. Ember Ruby Path B4F Northwest Ladder", "Mt. Ember Ruby Path B5F Ladder", "Icefall Cave Front Exit (North)",
    "Icefall Cave Front Ladder", "Icefall Cave 1F Exit (South)", "Icefall Cave 1F East Ladder",
...
BUILDING_ENTRANCE_PAIRS = {
    "Route 22 Gate Entrance (South)": "Route 22 Gate Entrance (North)",
    "Viridian Forest South Gate Entrance": "Viridian Forest North Gate Entrance",
    "Route 2 Gate Entrance (North)": "Route 2 Gate Entrance (South)",
    "Badge Guy's House Entrance (Front)": "Badge Guy's House Entrance (Back)",
    "Robbed House Entrance (Front)": "Robbed House Entrance (Back)",
    "Route 5 Gate Entrance (North)": "Route 5 Gate Entrance (South)",
    "Underground Path Entrance (North)": "Underground Path Entrance (South)",
    "Route 6 Gate Entrance (South)": "Route 6 Gate Entrance (North)",
    "Route 11 Gate Entrance (West)": "Route 11 Gate Entrance (East)",
    "Route 8 Gate Entrance (East)": "Route 8 Gate Entrance (West)",
    "Underground Path Entrance (East)": "Underground Path Entrance (West)",
    "Route 7 Gate Entrance (West)": "Route 7 Gate Entrance (East)",
    "Celadon Department Store Entrance (West)": "Celadon Department Store Entrance (East)",
    "Route 12 Gate Entrance (North)": "Route 12 Gate Entrance (South)",
    "Route 15 Gate Entrance (East)": "Route 15 Gate Entrance (West)",
    "Route 16 Gate Entrance (East - Top)": "Route 16 Gate Entrance (West - Top)",
    "Route 16 Gate Entrance (East - Bottom)": "Route 16 Gate Entrance (West - Bottom)",
    "Route 18 Gate Entrance (West)": "Route 18 Gate Entrance (East)",
    "Fuchsia Fishing House Entrance (Front)": "Fuchsia Fishing House Entrance (Back)",
    "Three Isle Path Entrance (West)": "Three Isle Path Entrance (East)",
    "Route 22 Gate Exit (South)": "Route 22 Gate Exit (North)",
    "Viridian Forest South Gate Exit (South)": "Viridian Forest North Gate Exit (North)",
    ...
    "Underground Path 1F Exit (North)": "Underground Path 1F Exit (South)",
    ...
    "Underground Path 1F Exit (East)": "Underground Path 1F Exit (West)",
    ...
    "Route 16 Gate 1F Exit (East - Top)": "Route 16 Gate 1F Exit (West - Top)",
    "Route 16 Gate 1F Exit (East - Bottom)": "Route 16 Gate 1F Exit (West - Bottom)",
...
DUNGEON_ENTRANCE_PAIRS = {
    ...
    "Mt. Moon Entrance (West)": "Mt. Moon Entrance (East)",
    "Diglett's Cave Entrance (North)": "Diglett's Cave Entrance (South)",
    "Rock Tunnel Entrance (North)": "Rock Tunnel Entrance (South)",
    "Power Plant Entrance (Front)": "Power Plant Entrance (Back)",
    "Seafoam Islands Entrance (North)": "Seafoam Islands Entrance (South)",
    "Victory Road Entrance (West)": "Victory Road Entrance (East)",
    "Pattern Bush Entrance (West)": "Pattern Bush Entrance (East)",
    "Viridian Forest Exit (South)": "Viridian Forest Exit (North)",
    "Mt. Moon 1F Exit": "Mt. Moon B1F East Ladder (Fourth Tunnel)",
    "Diglett's Cave 1F Exit (North)": "Diglett's Cave 1F Exit (South)",
...
def _set_seafoam_entrances(world: "PokemonFRLGWorld") -> None:
    seafoam_reverse_entrances = {
        "Seafoam Islands Entrance (North)": "Seafoam Islands 1F (Southeast)",
        "Seafoam Islands Entrance (South)": "Seafoam Islands 1F",
